...
type IconName = 'dashboard' | 'inbound' | 'team' | 'groups' | 'setting' | 'tool' | 'cluster' | 'hosts' | 'aimili' | 'logout' | 'apidocs' | 'outbound' | 'routing';
...
export default function AppSidebar() {
  ...
  const tabs = useMemo<{ key: string; icon: IconName; title: string }[]>(() => [
    ...
    { key: '/aimili', icon: 'aimili', title: t('menu.aimili', { defaultValue: 'Residential IP' }) },
